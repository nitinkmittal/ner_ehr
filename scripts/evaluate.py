...
"""
To run: 
After running python baseline.py -> bydefault would show the strict and loose evaluation for dictionary based model
python evaluate.py --goldpath "file path containing true labels" --predpath "filepath containing pred labels"
"""
...
if __name__ == "__main__":
	...
	parser.add_argument("--goldpath", type=str, default="test_true.csv", help="")
	parser.add_argument("--predpath", type=str, default="test_pred.csv", help="")
